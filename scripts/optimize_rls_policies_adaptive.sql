-- =====================================================
-- OPTIMIZAR POLÍTICAS RLS ADAPTATIVO
-- =====================================================
-- Este script optimiza las políticas RLS basándose en la estructura real de las tablas
...
-- =====================================================
-- PASO 2: CREAR POLÍTICAS OPTIMIZADAS ADAPTATIVAS
-- =====================================================

-- Administrators - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Condos - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Assemblies - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Emergency Plans - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Certifications - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Insurances - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Alerts - Políticas optimizadas (asumiendo que tiene user_id)
...
-- Notification Settings - Políticas optimizadas (asumiendo que tiene user_id)
