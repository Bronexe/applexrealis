...
// Ejecutar con: node scripts/test-integration-complete.js
...
async function testIntegrationComplete() {
  ...
  try {
    // Probar envío de email usando la Edge Function
    console.log('\n📧 Probando envío de email con Edge Function...')
    
    const { data, error } = await supabase.functions.invoke('send-email', {
      body: {
        to: 'sleon@slfabogados.cl',
        subject: '🎉 ¡Integración Completa Funcionando! - Lex Realis',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 8px 8px;">
              <h2 style="color: #BF7F11; margin-top: 0;">🎉 ¡Integración Completa Funcionando!</h2>
              
              <div style="background: #d4edda; border: 1px solid #c3e6cb; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="margin: 0; color: #155724;">
                  <strong>✅ ¡SISTEMA COMPLETAMENTE FUNCIONAL!</strong><br>
                  La integración de Supabase + Resend está funcionando perfectamente.
                </p>
              </div>
              
              <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #BF7F11;">
                <h3 style="margin-top: 0; color: #333;">Componentes Funcionando</h3>
                <p style="margin: 10px 0; color: #666;">
                  ✅ <strong>Supabase:</strong> Configurado correctamente
                </p>
                <p style="margin: 10px 0; color: #666;">
                  ✅ <strong>Edge Function:</strong> send-email funcionando
                </p>
                <p style="margin: 10px 0; color: #666;">
                  ✅ <strong>Resend:</strong> API Key válida y operativa
                </p>
                <p style="margin: 10px 0; color: #666;">
                  ✅ <strong>Envío de emails:</strong> Funcionando perfectamente
                </p>
              </div>
    ...
    console.log('✅ Edge Function send-email operativa')
