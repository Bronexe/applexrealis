-- =====================================================
-- CREAR SOLO LAS FUNCIONES DE LÍMITE DE CONDOMINIOS
-- =====================================================
-- Este script crea únicamente las funciones necesarias sin pruebas
...
SELECT 
    'Funciones creadas exitosamente:' as info,
    routine_name,
    routine_type,
    data_type
