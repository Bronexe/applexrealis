...
-- =====================================================
-- Este script elimina las funciones existentes y las recrea con los tipos correctos

-- 1. Eliminar funciones existentes
DROP FUNCTION IF EXISTS check_condos_limit(UUID);
DROP FUNCTION IF EXISTS get_condos_limit_info(UUID);
DROP FUNCTION IF EXISTS update_condos_limit(UUID, INTEGER);

-- 2. Crear función check_condos_limit con tipos correctos
...
-- 3. Crear función get_condos_limit_info con tipos correctos
...
-- 4. Crear función update_condos_limit con tipos correctos
...
-- 5. Verificar que las funciones se recrearon correctamente
SELECT 
    'Funciones recreadas exitosamente:' as info,
    routine_name,
    routine_type,
    data_type
...
-- 6. Probar que las funciones funcionan
DO $$ 
DECLARE
    test_user_id UUID;
    limit_check RECORD;
...
-- =====================================================
-- FUNCIONES RECREADAS CON TIPOS CORRECTOS
-- =====================================================
