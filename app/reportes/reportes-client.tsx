...
import { ReportAnalytics, Download, FileText, Building, Calendar, Shield, FileCheck } from "lucide-react"
...
export function ReportesClient({ condos }: ReportesClientProps) {
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-2">
                    ...
                    {condos.length > 0 ? (
                      condos.map((condo) => (
                        <SelectItem key={condo.id} value={condo.id}>
                          {condo.name} - {condo.address || condo.comuna || 'Sin dirección'}
                        </SelectItem>
                      ))
                    ) : (
                ...
                {condos.length === 0 && (
                  <p className="text-sm text-muted-foreground">
                    No hay condominios registrados. Crea un condominio primero para generar reportes.
                  </p>
                )}
              </div>
              ...
              {selectedCondo && (
                <div className="p-4 border rounded-xl bg-muted/50">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    ...
                    <p><strong>Dirección:</strong> {selectedCondo.address || selectedCondo.comuna || 'Sin dirección'}</p>
              ...
              <div className="flex gap-4">
                <Button type="submit" disabled={isLoading || !reportData.condo_id} className="rounded-xl">
