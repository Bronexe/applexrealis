...
interface ResponsiveLayoutWithSidebarProps {
  children: React.ReactNode
  currentPath?: string
}

export default function ResponsiveLayoutWithSidebar({ 
  children, 
  currentPath 
}: ResponsiveLayoutWithSidebarProps) {
  ...
  // En móviles, usar el navbar móvil
  if (isMobile) {
    return (
      <div className="min-h-screen bg-background">
        ...
        <footer className="border-t bg-card p-4 mt-auto">
